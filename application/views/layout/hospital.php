...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>LifeBank Hospital Administrator <?php echo (isset($title)) ? ":: " . $title : ""; ?> </title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="LifeBank Hospital Administrator">
                ...
                <div class="span2 sidebar-container">
                    ...
                    <div class="sidebar">
                        ...
                        <div class="nav-collapse collapse leftmenu">
                            ...
                            <ul>
                                <li ><a class="dashboard smronju" href="<?php echo $base; ?>hospital/user" title="Donors"><span>Users</span></a></li> 
                                <li><a class="tables" href="<?php echo $base; ?>hospital/donation" title="Donations"><span>Donations</span></a></li>
                                <li><a class="tables" href="<?php echo $base; ?>hospital/setting" title="Settings"><span>Settings</span></a></li>
                            </ul>
